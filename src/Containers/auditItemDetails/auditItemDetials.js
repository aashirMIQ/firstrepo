...
class ItemDetails extends Component {
  ...
  updateProductQuantity = () => {
    if (this.state.quantity) {
      ...
      productObj["qty_in_stock"] = Number(this.state.quantity);
      let product = {
      ...
      this.props.dispatch(updateProduct(null, product)).then(res => {
        ...
        this.setState({ quantity: "", disabled: true }, () => {
          toast.success("Successfully Audit", {
            position: toast.POSITION.BOTTOM_LEFT
          });
          this.props.history.push("/auditItem");
        });
      });
    }
  };
    ...
    return (
      <div>
        ...
        >
          ...
          >
            <img
              onClick={() => this.props.history.push("/auditItem")}
              className="menu-img"
              width="30px"
