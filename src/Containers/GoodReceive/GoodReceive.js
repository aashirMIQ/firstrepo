      ...
      <div>
        ...
        >
          <div className="main-title">
            <div>GOOD RECEIVEING</div>
            <div>
              <button onClick={this.updateInventory}>Items Received</button>
            </div>
          </div>
            ...
            this.state.updateRows.map((data, i) => {
              return (
                <div className="titles" key={i}>
                  <div style={styles.center}>{i + 1}</div>
                  ...
                  <div style={{ height: "100%", ...styles.center }}>{data.barcode}</div>
                  <div style={{ height: "100%" }}>
                    <input
                      className="inventory-input"
                      type="number"
                  ...
                  <div style={{ height: "100%" }}>
                    <input
                      ...
                      onChange={e =>
                        this.onChange(e.target.value, "standard_price", i)
                      }
                    />
                  </div>
                  <div style={{ height: "100%" }}>
                    <input
                      ...
                      onChange={e =>
                        this.onChange(e.target.value, "list_price", i)
                      }
                    />
                  </div>
                  <div style={{ height: "100%", ...styles.center }}>
                    {data.qty_in_stock && data.standard_price
                      ? data.qty_in_stock * data.standard_price
                      : 0}
                  </div>
