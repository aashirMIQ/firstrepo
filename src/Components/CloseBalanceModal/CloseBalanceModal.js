...
class CloseBalanceModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
        ...
        <Modal show={this.props.show} onHide={this.props.onHide}>
          ...
          >
            <Modal.Header closeButton>
              <Modal.Title>Set Closing Balance</Modal.Title>
            </Modal.Header>
...
export default connect(mapStateToProps)(CloseBalanceModal);
